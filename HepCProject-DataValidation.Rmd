...
meds_inpt<- read_delim("Z:/RAW NEW 3.10.2017/2017 03 10/Meds_Inpt.txt", "|", escape_double = FALSE, trim_ws = TRUE)#Cindy's path for new data files

meds_outpt<- read_delim("Z:/RAW NEW 3.10.2017/2017 03 10/Meds_Outpt.txt", "|", escape_double = FALSE, trim_ws = TRUE)#Cindy's path for new data files

procedure_icd<-read_delim("Z:/RawData/TextFormat/Procedure_ICD.txt", "|", escape_double = FALSE, trim_ws = TRUE)

social_hx<-read_delim("Z:/RAW NEW 3.10.2017/2017 03 10/Social_Hx.txt", "|", escape_double = FALSE, trim_ws = TRUE)#Cindy's data path for new file

relevant_icd<-read_csv("Z:/HristinasFolder/ICDCodes.xlsx - Sheet2.csv")

education<-read_delim("Z:/RAW NEW 3.28.2017/EDUCATION_20170329.txt", "|", escape_double = FALSE, trim_ws = TRUE)#Cindy's data path for new demo table

labs <- read_delim("Z:/RAW NEW 3.10.2017/2017 03 10/Labs.txt", "|", escape_double = FALSE, trim_ws = TRUE)#Cindy's path for new data files
...
meds_outpt$Enc_DT_DS <- as.date.POSIXct(meds_outpt$Enc_DT_DS)
meds_outpt$Med_Dept <- as.factor(meds_outpt$Med_Dept)
meds_outpt$Order_DT_DS <- as.date.POSIXct(meds_outpt$Order_DT_DS)
...
meds_outpt$Order_Start_DTTM_DS <- as.date.POSIXct(meds_outpt$Order_Start_DTTM_DS)
meds_outpt$Order_End_DTTM_DS <- as.date.POSIXct(meds_outpt$Order_End_DTTM_DS)
...
#procedure_icd$procedure_dt_ds<as.Date.default(procedure_icd$procedure_dt_ds)
procedure_icd$proc_rank<-as.factor(procedure_icd$proc_rank)
procedure_icd$ICD_TYPE<-as.factor(procedure_icd$ICD_TYPE)



social_hx$Patient_ID<-social_hx$Patient_ID
social_hx$Encounter_ID<-social_hx$Encounter_ID
social_hx$Pat_Enc_Csn_ID_DID<-social_hx$Pat_Enc_Csn_ID_DID
social_hx$Enc_DT_DS<-social_hx$Enc_DT_DS
social_hx$Hx_SOURCE_C<-social_hx$Hx_SOURCE_C
social_hx$Hx_SOURCE<-social_hx$Hx_SOURCE
social_hx$TOBACCO_USER_C<-social_hx$TOBACCO_USER_C
social_hx$TOBACCO_USER<-social_hx$TOBACCO_USER
social_hx$SMOKING_TOB_USE_C<-social_hx$SMOKING_TOB_USE_C
social_hx$SMOKING_TOB_USE<-social_hx$SMOKING_TOB_USE
social_hx$TOBACCO_PAK_PER_DY<-social_hx$TOBACCO_PAK_PER_DY
social_hx$TOBACCO_USED_YEARS<-social_hx$TOBACCO_USED_YEARS
social_hx$TOBACCO_COMMENT<-social_hx$TOBACCO_COMMENT
social_hx$SMOKING_START_DATE_DS<-social_hx$SMOKING_START_DATE_DS
social_hx$SMOKING_QUIT_DATE_DS<-social_hx$SMOKING_QUIT_DATE_DS
social_hx$CIGARETTES_YN<-social_hx$CIGARETTES_YN
social_hx$PIPES_YN<-social_hx$PIPES_YN
social_hx$CIGARS_YN<-social_hx$CIGARS_YN
social_hx$SMOKELESS_TOB_USE_C<-social_hx$SMOKELESS_TOB_USE_C
social_hx$SMOKELESS_TOB_USE<-social_hx$SMOKELESS_TOB_USE
social_hx$SNUFF_YN<-social_hx$SNUFF_YN<
social_hx$CHEW_YN<-social_hx$CHEW_YN
social_hx$SMOKELESS_QUIT_DATE_DS<-social_hx$SMOKELESS_QUIT_DATE_DS
social_hx$ALCOHOL_USE_C<-social_hx$ALCOHOL_USE_
social_hx$ALCOHOL_USE<-social_hx$ALCOHOL_USE
social_hx$HX_DRINK_TYPES_C<-social_hx$HX_DRINK_TYPES_C
social_hx$HX_DRINK_TYPES<-social_hx$HX_DRINK_TYPES
social_hx$ALCOHOL_DRINKS_WK<-social_hx$ALCOHOL_DRINKS_WK
social_hx$ALCOHOL_OZ_PER_WK<-social_hx$ALCOHOL_OZ_PER_WK
social_hx$ALCOHOL_COMMENT<-social_hx$ALCOHOL_COMMENT
social_hx$ILL_DRUG_USER_C<-social_hx$ILL_DRUG_USER_C
social_hx$ILL_DRUG_USER<-social_hx$ILL_DRUG_USER
social_hx$IV_DRUG_USER_YN<-social_hx$IV_DRUG_USER_YN
social_hx$ILLICIT_DRUG_FREQ<-social_hx$ILLICIT_DRUG_FREQ
social_hx$ILLICIT_DRUG_CMT<-social_hx$ILLICIT_DRUG_CMT
social_hx$SEXUALLY_ACTIVE_C<-social_hx$SEXUALLY_ACTIVE_C
social_hx$SEXUALLY_ACTIVE<-social_hx$SEXUALLY_ACTIVE
social_hx$FEMALE_PARTNER_YN<-social_hx$FEMALE_PARTNER_YN
social_hx$MALE_PARTNER_YN<-social_hx$MALE_PARTNER_YN<
social_hx$CONDOM_YN<-social_hx$CONDOM_YN
social_hx$PILL_YN<-social_hx$PILL_YN
social_hx$DIAPHRAGM_YN<-social_hx$DIAPHRAGM_YN
social_hx$IUD_YN<-social_hx$IUD_YN
social_hx$SURGICAL_YN<-social_hx$SURGICAL_YN
social_hx$SPERMICIDE_YN<-social_hx$SPERMICIDE_YN<
social_hx$IMPLANT_YN<-social_hx$IMPLANT_YN
social_hx$RHYTHM_YN<-social_hx$RHYTHM_YN
social_hx$INJECTION_YN<-social_hx$INJECTION_YN
social_hx$SPONGE_YN<-social_hx$SPONGE_YN
social_hx$INSERTS_YN<-social_hx$INSERTS_YN
social_hx$ABSTINENCE_YN<-social_hx$ABSTINENCE_YN
social_hx$SEX_COMMENT<-social_hx$SEX_COMMENT
social_hx$UNKNOWN_FAM_HX_YN<-social_hx$UNKNOWN_FAM_HX_YN<
social_hx$OCCUPATION_C<-social_hx$OCCUPATION_C
social_hx$OCCUPATION<-social_hx$OCCUPATION
social_hx$EMPY_STATUS_C<-social_hx$EMPY_STATUS_C
social_hx$EMPLOYMENT_STATUS<-social_hx$EMPLOYMENT_STATUS
social_hx$Response_Count<-social_hx$Response_Count
...
labs$line_comment
labs$reference_unit
labs$result_in_range_yn
labs$result_flag

###update field names to caps
### see if we need to pad decimal ICD and CPT
